defmodule JResidenceWeb.CustomerLiveTest do
  ...
  @create_attrs %{address: "some address", date_of_birth: "some date_of_birth", date_of_expiry: "some date_of_expiry", date_of_issue: "some date_of_issue", emergency_contact: "some emergency_contact", first_name: "some first_name", first_name_alt: "some first_name_alt", id_number: "some id_number", issue_by: "some issue_by", last_name: "some last_name", last_name_alt: "some last_name_alt", line: "some line", nationality: "some nationality", occupation: "some occupation", phone: "some phone", photo: "some photo", religion: "some religion", sex: "some sex"}
  @update_attrs %{address: "some updated address", date_of_birth: "some updated date_of_birth", date_of_expiry: "some updated date_of_expiry", date_of_issue: "some updated date_of_issue", emergency_contact: "some updated emergency_contact", first_name: "some updated first_name", first_name_alt: "some updated first_name_alt", id_number: "some updated id_number", issue_by: "some updated issue_by", last_name: "some updated last_name", last_name_alt: "some updated last_name_alt", line: "some updated line", nationality: "some updated nationality", occupation: "some updated occupation", phone: "some updated phone", photo: "some updated photo", religion: "some updated religion", sex: "some updated sex"}
  @invalid_attrs %{address: nil, date_of_birth: nil, date_of_expiry: nil, date_of_issue: nil, emergency_contact: nil, first_name: nil, first_name_alt: nil, id_number: nil, issue_by: nil, last_name: nil, last_name_alt: nil, line: nil, nationality: nil, occupation: nil, phone: nil, photo: nil, religion: nil, sex: nil}
