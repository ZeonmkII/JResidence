defmodule JResidenceWeb.RoomLiveTest do
  use JResidenceWeb.ConnCase

  import Phoenix.LiveViewTest
  import JResidence.FacilitiesFixtures

  @create_attrs %{b_booked: "some b_booked", b_occupied: "some b_occupied", room_number: "some room_number"}
  ...
  describe "Index" do
    ...
    test "updates room in listing", %{conn: conn, room: room} do
      ...
      assert html =~ "some updated b_booked"
    end
